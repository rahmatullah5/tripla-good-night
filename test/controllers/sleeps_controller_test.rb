...
class SleepsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sleep" do
    assert_difference("Sleep.count") do
      post sleeps_url, params: { sleep: { clock_in: @sleep.clock_in, clock_out: @sleep.clock_out, user_id: @sleep.user_id } }
    end
  ...
  test "should update sleep" do
    patch sleep_url(@sleep), params: { sleep: { clock_in: @sleep.clock_in, clock_out: @sleep.clock_out, user_id: @sleep.user_id } }
